...
import { GEN16, Discord, TG, TW } from "assets/icons";
...
export const Layout = ({ children }: { children?: any }) => {
  ...
  return (
    <div className={"ton-background"}>
      ...
      <Container gap={2} fluid css={{ display: "flex", paddingBottom: "$16" }}>
          ...
          <Container alignItems="center" fluid>
            <Grid.Container gap={2} justify="space-between">
              ...
              >
                ...
                <Spacer x={0.4} />
                <Text css={{ maxW: 590 }}>{t("footerDescription")}</Text>
              </Grid>
              <Grid>
                <Grid.Container>
                  <Grid>
                    <Text size={18}>Analytics</Text>
                    <ul>
                      <li>{t('apps')}</li>
                      <li>{t('glossary')}</li>
                      <li>{t('developers')}</li>
